...
//Homework begins here 2/17/2021
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    // get help from tutor on this portion??!
...
//DELIVERABLE #2 BEGINS HERE
// Below is the starter code from bellybutton bubble chart, given in module
...
//DELIVERABLE 3 BEGINS BELOW!!!
 // Create a variable that holds the samples array. 
  ...
  var metaArray  = metadata.filter(i => i.id == sample);
    ...
    //??? Does any forumula go here? Check with tutor
